...
final class DonationController
{
    public function index(): string
    {
        ...
        $rows  = Donation::all($status !== '' ? $status : null, $from !== '' ? $from : null, $to !== '' ? $to : null);
        $total = Donation::totalCompleted($from !== '' ? $from : null, $to !== '' ? $to : null);

        return View::render('admin/donations/index.twig', [
            'title'     => 'Donations',
            'donations' => $rows,
            'total'     => $total,
