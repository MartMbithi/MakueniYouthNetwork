...
final class ProgramController
{
    ...
    {
        return View::render('public/programs.twig', [
    ...
    public function show(string $slug): string
    {
        ...
        $children = Program::children((int) $program['id']);
        $parent = null;
        if (!empty($program['parent_id'])) {
            $parent = Program::find((int) $program['parent_id']);
        }
        return View::render('public/program-show.twig', [
            'program'  => $program,
            'children' => $children,
            'parent'   => $parent,
            'title'    => $program['title'],
